...
| [x]  | VITAL-03 | P0  | Buyer identity onboarding              | Complete the Didit sandbox flow, close/reopen once while it is pending, then refresh after approval.                                        | Progress resumes at the real state; verification creates/activates exactly one buyer profile.                                        | PASS   |                                                                                                                                                                                                                                                                               |                  |
...
Open bugs/blockers: BUG-001 through BUG-009<br>
...
Open bugs/blockers: BUG-010 through BUG-017<br>
Tester/sign-off/date:
...
| ---------------------------------------------- | ---------------: | ---: | ---: | ------: | --: | --------------------: | ---------: | --------------------------------------- | ---------- |
| **Phase 1A.1 onboarding through offer draft**  |           **18** |   15 |    2 |         |     |                     0 |          2 | **IN PROGRESS — 1 result not recorded** |            |
