...
export const glass = {
  ...
  control: {
    backgroundColor: platformValue("rgba(240,244,248,0.56)", "#F5F7F9"),
    borderWidth: 1,
    borderColor: "rgba(221,221,221,0.44)",
  ...
  segmentActive: {
    backgroundColor: platformValue("rgba(255,255,255,0.64)", "#FFFFFF"),
    borderWidth: 1,
    borderColor: "rgba(221,221,221,0.46)",
